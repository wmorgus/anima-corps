...
**Agent, mode, or human — unresolved, same as 027.** §6.1 licenses the *slot*, not the occupant. Cadence (§6.8, always-on) pushes off human; intent-referencing (§3.2, reconstruct against the spine) pushes off dumb infrastructure. Lean: §6 agent. Not staked — §5.6 forbids inventing the agent before pressure is felt, and the pressure here is argued, not yet felt. Carried into §6.18 as [OPEN — candidate].
